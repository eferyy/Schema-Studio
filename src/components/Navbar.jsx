        ...
        <div className="relative group inline-block">
          ...
          <div className="absolute right-0 top-full pt-1 w-64 hidden group-hover:block z-50">
            <div className="bg-white border border-gray-200 rounded shadow-lg overflow-hidden">
              <Link to="/generate/organization-schema" className="block px-4 py-2 text-sm text-gray-700 hover:bg-gray-50 hover:text-blue-600">Free Organization Schema Generator</Link>
              <Link to="/generate/faq-schema" className="block px-4 py-2 text-sm text-gray-700 hover:bg-gray-50 hover:text-blue-600">Advanced FAQ JSON-LD Generator</Link>
            </div>
          </div>
        </div>
      </div>
